...
>抛物线 $y^2=2px$ ，过点 $Q(q,0)$ 有直线 $AC:x=m_{1}y+q、BD:y=m_{2}x+q$ 交抛物线于 $A(左上）、B（右上）、C（左下）、D（右下）$ ，连接 $AD、BC$ 分别交 $x$ 轴于 $M、N$ ，则 $\frac{x_{N}}{q}=\frac{q}{x_{M}}=\frac{QN}{QM}=\frac{k_{AD}}{k_{BC}}$.  
